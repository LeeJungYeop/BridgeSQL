...
from bridgesql.formatters import format_markdown_table, safe_join, truncate
from bridgesql.state import _ensure_imports, get_connector, get_schema
...
async def _generate(args: dict) -> list[TextContent]:
    _ensure_imports()
    from bridgesql.engine.sql_generator import SQLGenerator, format_schema_for_prompt
    from bridgesql.engine.validator import SQLValidator

...
def _ensure_imports() -> None:
    ...
    if DatabaseConnector is None:
        from bridgesql.db.connector import DatabaseConnector as _dc
        from bridgesql.rag.retriever import SemanticRetriever as _sr
        from bridgesql.semantic.catalog import SemanticCatalog as _sc
